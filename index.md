...
<div style="background-image: linear-gradient(rgba(26,43,76,0.85), rgba(26,43,76,0.85)), url('/expertise-bg.jpg'); background-size:cover; background-position:center; color:#fff; padding:64px 24px;">
<h2>Our Expertise</h2>
